...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link rel="shortcut icon" href="../../../js/tinymce/plugins/filemanager/ico/favicon.ico">
        <link href="../../../js/tinymce/plugins/filemanager/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="../../../js/tinymce/plugins/filemanager/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />
        <link href="../../../js/tinymce/plugins/filemanager/css/bootstrap-lightbox.min.css" rel="stylesheet" type="text/css" />
        <link href="../../../js/tinymce/plugins/filemanager/css/style.css" rel="stylesheet" type="text/css" />
	<link href="../../../js/tinymce/plugins/filemanager/css/dropzone.css" type="text/css" rel="stylesheet" />
	<!--[if lt IE 8]><style>
	.img-container span {
        ...
        <script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/jquery.1.9.1.min.js"></script>
        <script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/bootstrap-lightbox.min.js"></script>
	<script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/dropzone.min.js"></script>
	<script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/jquery.touchSwipe.min.js"></script>
	<script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/modernizr.custom.js"></script>
	<script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/bootbox.min.js"></script>
	<script>
	...
	<script type="text/javascript" src="../../../js/tinymce/plugins/filemanager/js/include.js"></script>
    </head>
    <body>
...
?>
    ...
    <div id="loading_container" style="display:none;">
	    ...
	    <img id="loading_animation" src="../../../js/tinymce/plugins/filemanager/img/storing_animation.gif" alt="loading" style="z-index:10001; margin-left:-32px; margin-top:-32px; position:fixed; left:50%; top:50%"/>
    </div>
    <!----- loading div end ------->
